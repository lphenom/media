...
/**
 * PHAR build script for lphenom/media.
 *
...
$pharFile = $buildDir . '/lphenom-media.phar';

if (file_exists($pharFile)) {
    unlink($pharFile);
}

$phar = new Phar($pharFile, 0, 'lphenom-media.phar');
$phar->startBuffering();
...
$stub = <<<'STUB'
<?php
Phar::mapPhar('lphenom-media.phar');
require 'phar://lphenom-media.phar/vendor/autoload.php';
__HALT_COMPILER();
STUB;
